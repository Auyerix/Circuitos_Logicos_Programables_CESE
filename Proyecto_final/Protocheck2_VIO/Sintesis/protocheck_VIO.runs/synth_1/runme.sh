...
HD_PWD='C:/Working/CLP_Programs/Codigos/Protocheck2_VIO/Sintesis/protocheck_VIO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log protocheck_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source protocheck_VIO.tcl
