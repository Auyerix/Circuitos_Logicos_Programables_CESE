...
HD_PWD='C:/Working/CLP_Programs/Codigos/Protocheck2_VIO/Sintesis/protocheck_VIO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log protocheck_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source protocheck_VIO.tcl -notrace
